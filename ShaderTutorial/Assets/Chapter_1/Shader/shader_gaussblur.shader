//from web https://blog.csdn.net/poem_qianmo/article/details/51871531

Shader "Tutorial2D_AfterEffect/shader_gaussblur"
{
	//-----------------------------------【属性 || Properties】------------------------------------------  
	// 这是一个后处理Shader,并不是一个实时执行的Shader
	// 需要C#配合该Shader共同完成渲染效果
	Properties
	{
		//主纹理
	...
	//【6】Pass0 顶点着色函数 || Vertex Shader Function
	...
	//【7】Pass0 片段着色函数 || Fragment Shader Function
	...
	//【9】Pass1 顶点着色函数 || Vertex Shader Function
	...
	//【10】Pass2 顶点着色函数 || Vertex Shader Function
	...
	//【11】Pass1&Pass2 片段着色函数 || Fragment Shader Function
