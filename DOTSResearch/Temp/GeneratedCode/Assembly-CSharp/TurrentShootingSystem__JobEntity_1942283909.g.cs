...
#line 1 "/Users/ccimonyang/Desktop/GitHub/UnityResearch/DOTSResearch/Temp/GeneratedCode/Assembly-CSharp/TurrentShootingSystem__JobEntity_1942283909.g.cs"
...
partial struct TurrentShoot : IJobChunk
{
    [Unity.Collections.ReadOnly]
    public TurrentAspect.TypeHandle __TurrentAspectTypeHandle;
    [global::System.Runtime.CompilerServices.CompilerGenerated]
    ...
    {
        var __TurrentAspectTypeHandleArray = __TurrentAspectTypeHandle.Resolve(batch);
        ...
        if (!useEnabledMask)
        {
            ...
            {
                var __TurrentAspectTypeHandleArrayArray = __TurrentAspectTypeHandleArray[i];
                Execute(in __TurrentAspectTypeHandleArrayArray);
                matchingEntityCount++;
            }
        }
        else
